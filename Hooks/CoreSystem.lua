...
-- Disabled for now, this crashes when overriding existing units, probably related to <dependencies> node on the unit
-- @HW12 if you can make this just work without needing this dumb workaround it would be really good
